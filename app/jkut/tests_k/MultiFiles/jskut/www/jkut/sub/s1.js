...
import * as s21 from  "../sub/sub2/s21.js";

const a = sys.$checkNull(0);

export const A = sys.$checkNull([a]);
{
A[0] =sys.$checkExists(A[0], sys.$checkNull(1800));
}


export function hello21  (n)  { return s21.hello(n);};
